...
void GMainWindow::InitializeHotkeys() {
    ...
    ui.action_Start->setShortcut(GetKeySequence("Main Window", "Continue/Pause Emulation"));
    ui.action_Start->setShortcutContext(GetShortcutContext("Main Window", "Continue/Pause Emulation"));
    ...
    connect(GetHotkey("Main Window", "Continue/Pause Emulation", this), &QShortcut::activated, this, [&] {
    ...
    connect(GetHotkey("Main Window", "Restart Emulation", this), &QShortcut::activated, this, [this] {
